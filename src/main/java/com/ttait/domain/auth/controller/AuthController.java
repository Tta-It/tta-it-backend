...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Long>>> signUpAdmin(@Valid @RequestBody SignUpRequest request) {
    ...
    public ResponseEntity<ApiResponse<Map<String, Long>>> signUpCompanyAdmin(@Valid @RequestBody SignUpRequest request) {
